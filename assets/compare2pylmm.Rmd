...
[the code](https://github.com/kbroman/lmmlite/tree/gh-pages/compare2pylmm/try_pylmm.py))
and saved the results to a CSV file, which we'll now load.

```{r load_pylmm_results}
pylmm <- read.csv("../compare2pylmm/pylmm_results.csv", as.is=TRUE)
```
