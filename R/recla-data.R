...
#' @name recla
#' @title Example kinship, phenotype, and covariate data
#'
#' @description Estimated kinship matrix, phenotypes, and covariates
#' for diversity outcross mice, taken from Recla et al. (2014) and
#' Logan et al. (2013)
#'
...
#'
#' Logan RW, Robledo RF, Recla JM, Philip VM, Bubier JA, Jay JJ,
#' Harwood C, Wilcox T, Gatti DM, Bult CJ, Churchill GA, Chesler EJ
